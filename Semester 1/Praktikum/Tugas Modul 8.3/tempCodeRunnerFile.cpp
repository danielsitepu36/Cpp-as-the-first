...
int binarysearch(tabel data[],long long unsigned query,int j);
void sequenceedit(tabel data[],int s,int n);
...
int main(){
    ...
    awal:
    int menusort,carasort,pilihsoal;
    long long unsigned s,s2;
    char re;
    ...
    cin>>pilihsoal;
    if(pilihsoal==1){
        cout<<"Anda Memilih Sorting Data"<<endl;
        goto menusorting;
    }
    else if(pilihsoal==2){
        cout<<"Anda Memilih Searching Data"<<endl;
        goto search;
    }
    else if(pilihsoal==3){
    ...
    search:
    selection(n,data,1);
    cout<<"Masukkan data NISN yang ingin anda cari = ";
    cin>>s;
    s2=binarysearch(data,s,n);
    if(s2=0){
        cout<<"Tidak Ditemukan !"<<endl;
    }
    else{
        cout<<"Ditemukan !"<<endl;
        cout<<"NISN = "<<data[s2].NISN<<endl;
        cout<<"Nama = "<<data[s2].nama<<endl;
        cout<<"Nilai = "<<data[s2].nilai<<endl;
    }
    goto replay;

    edit:
    cout<<"Masukkan data dari nilai yang ingin anda edit = ";
    cin>>s;
    sequenceedit(data,s,n);
    showtable(data);
    goto replay;
...
int binarysearch(tabel data[],long long unsigned s,int j){
    bool found=false;
    int i=0,k;
    while(!found && i<=j){
        k=(i+j)/2;
...
void sequenceedit(tabel data[],int s,int n){
    ...
    for(int i=0;i<n;i++){
        if(data[i].nilai==s){
            found=true;
            cout<<"------------------------------------------------------"<<endl;
	    	cout<<"Masukkan NISN siswa ke-"<<i+1<<"	: ";
	    	cin>>data[i].NISN;
